...
if ($result->num_rows > 0) {
    ...
    $sql = "INSERT INTO shop_reservations (username, product, picture, price, quantity, date_time) 
            VALUES ('$username', '$productName', '$productPicture', '$productPrice', '$quantity', '$dateTime')";
